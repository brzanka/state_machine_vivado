...
HD_PWD='C:/Users/praktykant2/workspace_vivado/state_machine/state_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log thermo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source thermo.tcl
